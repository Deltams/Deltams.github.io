...
export default class RiskManager extends Component {
    ...
    async getCheckTraders() {
        if (this.state.userAccount !== ""){
            ...
            try {
                this.setState({arrHFTraderDelete: await RiskManagerContract.checkTraders(ethers.parseUnits(this.state.startNumber, 0), ethers.parseUnits(this.state.endNumber, 0))});
